...
menuitem-debugFetchWebContent = 重新獲取網頁總結內容
web-summary-debug-fetch-start = 正在通過 ChatGPT API/DOM 重新獲取總結內容...
web-summary-debug-fetch-success = 調試獲取成功！已建立含除錯資訊的筆記
web-summary-debug-fetch-failed = 調試獲取網頁總結失敗
