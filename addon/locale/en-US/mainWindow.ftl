...
menuitem-debugFetchWebContent = Re-fetch Web Summary Content
web-summary-debug-fetch-start = Re-fetching web summary content via ChatGPT API/DOM...
web-summary-debug-fetch-success = Debug fetch success! Note created with debug info
web-summary-debug-fetch-failed = Debug fetch failed
